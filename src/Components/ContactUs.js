    ...
    >
      <div className="flex flex-col p-4 sm:flex-row justify-around font-light mb-10">
        ...
        <div className="flex flex-col">
          <div className="flex flex-col items-start sm:items-end mb-2">
            ...
            <div className="flex justify-end gap-2">
              <p className="font-medium m-0">Phone Number:</p>
      ...
      <div className="flex gap-3 items-center w-full justify-center p-2">
        <a target="_blank" rel="noreferrer" href="https://csivit.com/">
          <img src="/images/Logo.png" className="h-7 max-w-full" alt="CSI_logo" />
        </a>
        <hr className="h-7 bg-white w-px m-0" />
        <a href="https://gravitas.vit.ac.in/" target="_blank" rel="noreferrer">
          <img src="/images/Gravitas.svg" className="h-7 max-w-full" alt="Devspace_logo" />
        </a>
      </div>
    </footer>
  );
